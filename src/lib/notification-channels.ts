  ...
  import('@tauri-apps/api/event').then(({ listen }) => {
    ...
    listen('show-notification-with-channel', async (event) => {
      ...
      try {
        ...
        console.log('🎯 FRONTEND: Processing notification:', { title, body, channelId, notificationType });
 ...
 */
export async function testNotification(type: 'INFO' | 'WARNING' | 'ERROR' | 'SUCCESS' | 'CRITICAL'): Promise<void> {
