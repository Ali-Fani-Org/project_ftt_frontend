			...
			<div class="flex justify-center">
				<div class="relative">
					...
					{#if hoveredSlice !== null}
						...
						<div
							class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-full -mt-8 bg-base-100 border border-base-300 rounded-lg shadow-lg p-3 z-50 pointer-events-none"
						>
